#ifndef ___LOGGINGCLASS
#define ___LOGGINGCLASS
#include "log.h"
...
long long int Logging::cputime() {
  ...
  return RU.ru_utime.tv_sec * 1000000 + (double)RU.ru_utime.tv_usec;
#else
  return 0;
#endif
}
